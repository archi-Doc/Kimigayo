...
This unit covers the existing Copy-element operations on complete owned tuples and fixed arrays. It does not add partial Move, per-element initialization/destruction state, Non-Copy extraction/replacement, Properties, struct fields, references, Slices or dynamic collections. See [static paths](../../spec/15-ownership-and-lifetime-analysis.md#1513-move-paths-and-partial-move), [overlap rules](../../spec/15-ownership-and-lifetime-analysis.md#1562-place-overlap-and-conflicts) and [receiver protection](../../spec/04-arrays-indexing-and-slices.md#464-bounds-evaluation-and-failure).
