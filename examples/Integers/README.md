...
See [STATUS.md C.46](../../STATUS.md#4-llvm-generation-coverage). General integer conversions, i128/u128, floating-point execution, char operations and the existing capture/ownership boundaries remain outside this increment.
