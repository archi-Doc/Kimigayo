    ...
    private void CheckOperation(int index)
    {
        ...
        switch (operation.Kind)
        {
            ...
            case OwnershipOperationKind.CompleteConstruction:
                ...
                break;
            case OwnershipOperationKind.ProjectElement or OwnershipOperationKind.LocateReceiver or OwnershipOperationKind.Read or OwnershipOperationKind.Consume or OwnershipOperationKind.Borrow or OwnershipOperationKind.CallEntry or OwnershipOperationKind.Deliver or OwnershipOperationKind.DecomposeCase or OwnershipOperationKind.AcquirePattern or OwnershipOperationKind.PatternTest:
