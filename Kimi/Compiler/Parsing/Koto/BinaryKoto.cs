...
{// A.B
    ...
    public MemberAccessKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
...
{// A[B]
    ...
    public IndexKoto(ref TokenReader reader, TextSpan range, Koto left, Koto index)
...
{// A * B
    ...
    public AsteriskKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A@B
    ...
    public ConversionKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A / B
    ...
    public SlashKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A % B
    ...
    public PercentKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A + B
    ...
    public PlusKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A - B
    ...
    public MinusKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A << B
    ...
    public LessThanLessThanKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A >> B
    ...
    public GreaterThanGreaterThanKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A < B
    ...
    public LessThanKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A <= B
    ...
    public LessThanEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A > B
    ...
    public GreaterThanKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A >= B
    ...
    public GreaterThanEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A as B
    ...
    public AsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A is B
    ...
    public IsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A == B
    ...
    public EqualsEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A != B
    ...
    public ExclamationEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A & B
    ...
    public AmpersandKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A ^ B
    ...
    public CaretKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A | B
    ...
    public BarKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A and B
    ...
    public AndKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A or B
    ...
    public OrKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A = B
    ...
    public EqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A += B
    ...
    public PlusEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A -= B
    ...
    public MinusEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A *= B
    ...
    public AsteriskEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A /= B
    ...
    public SlashEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A %= B
    ...
    public PercentEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A &= B
    ...
    public AmpersandEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A ^= B
    ...
    public CaretEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A |= B
    ...
    public BarEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A <<= B
    ...
    public LessThanLessThanEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
{// A >>= B
    ...
    public GreaterThanGreaterThanEqualsKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
        : base(ref reader, range, left, right)
    {
    }
...
public abstract partial class BinaryKoto : Koto
{
    ...
    public BinaryKoto(ref TokenReader reader, TextSpan range, Koto left, Koto right)
