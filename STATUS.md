...
- **Diagnostics:** warn for while true, unintended inferred Unit tails and provably effect-free discarded scalar values. Calls are not assumed pure, and final defer placement alone produces no warning.
