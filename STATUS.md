...
Programs 1–14 have target-level native coverage in the current audit. Programs 15–17 and SpecTour still illustrate broader required semantics. Parser coverage and adopted documentation do not establish end-to-end executability. User constructor, closure, generic, reference and sequence support should be read from the bounded areas above, not older blanket omissions.
