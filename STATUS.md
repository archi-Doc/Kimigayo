...
The **2026-09-20 documentation parser review (DM6)** corrects emphasis matching after partial delimiter consumption, NUL handling in links and delimiter classification, empty-link depth limits, and recursive node string formatting. URL encoding now writes UTF-8 percent escapes without per-character temporary strings. Both solution configurations build without warnings/errors; all **10,589 managed tests** pass per configuration, including 28 new cases and 10,000 generated inputs checked against pinned official CommonMark results. [Review evidence](PLAN_HISTORY.md#documentation-markdown-review-20260920) and [bounded performance measurements](Benchmark/DocumentationMarkdown.md#dm6-parser-review-2026-09-20). No NativeAOT or separate native fixture run was performed.
