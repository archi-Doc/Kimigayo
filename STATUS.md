...
Existing compiler limits still apply to test bodies: external-module generation, dynamic static initialization/shutdown and full generic resource-plan separation are unfinished (PLAN I11/I16/I28/I30/I31). Such unsupported generation fails before case launch; listing may succeed for semantically valid code that the native backend cannot yet emit. Named execution profiles remain deferred by the specification. NativeAOT was not run.
