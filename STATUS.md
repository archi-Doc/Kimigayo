...
subplace access remain unsupported. Concrete C struct layouts now preserve written order
...
Open/derived/empty C structs and direct zero-sized fields reject; broader C formation
