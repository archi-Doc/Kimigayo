...
public class ProjectedBorrowEmissionTest
{
    ...
    {
        var source = "struct Box<T>\n    let prefix: isize\n    let values: T\n    public init(prefix: isize, values: T)\n        self.prefix = prefix\n        self.values = values\n    public func view(self: ref/Self) -> ref/T from self => self.values@ref/T\n" +
