...
public class ReferenceEmissionTest
{
    ...
    {
        var source = $"func compare(a: ref/string, b: ref/string) -> bool => a {op} b\nlet a = \"{a}\"\nlet b = \"{b}\"\nif compare(a, b) => Console.writeLine(\"true\") else => Console.writeLine(\"false\")";
