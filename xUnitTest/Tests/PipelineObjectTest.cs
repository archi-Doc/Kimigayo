...
public class PipelineObjectTest
{
    ...
    [InlineData("let owner = Kimi.makeObj(Counter.init())\nlet target = owner@uniq/Counter")]
    [InlineData("var owner = Kimi.makeObj(Counter.init())\nlet target = owner@uniq/i32")]
    [InlineData("let value: i32 = 1\nlet owner = Kimi.makeObj(value@ref)")]
