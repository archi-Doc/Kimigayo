...
public class RequireContinuationTest
{
    ...
    [InlineData("let s = \"s\"", "require c else => return", "writeLine(s)\n        stop()", "writeLine(s)", OwnershipFailure.PossiblyMovedUse)]
    ...
    public void DefaultRequireDoesNotCreateRuntimeCompletion(string condition)
        => ScalarEmissionTest.EmitFixture("NeverRequire" + Configuration + "Default" + condition, Default + "writeLine(\"begin\")\nvalue(" + condition + ")", "begin\n", timeoutMilliseconds: 200);
