...
public class BranchReplayContinuationTest
{
    ...
    [InlineData("Move", "var x = \"old\"", "return", "if c => _ = x@move else => ()\n            x = \"new\"", "()", "Console.writeLine(x)", true)]
    [InlineData("MoveExit", "var x = \"old\"", "return", "if c => _ = x@move else => ()\n            x = \"new\"", "()", "Console.writeLine(x)", false)]
    ...
    [InlineData("let x = \"s\"", "return", "if c => _ = x@move else => ()", "()", "Console.writeLine(x)", OwnershipFailure.PossiblyMovedUse)]
    [InlineData("let x = \"s\"", "return", "if c => () else => _ = x@move", "()", "Console.writeLine(x)", OwnershipFailure.PossiblyMovedUse)]
    ...
    [InlineData("let x = \"s\"", "return", "while c => _ = x@move", "()", "()", OwnershipFailure.PossiblyMovedUse)]
    [InlineData("var x = \"s\"", "return", "while c\n                if c => _ = x@move else => ()", "()", "Console.writeLine(x)", OwnershipFailure.PossiblyMovedUse)]
