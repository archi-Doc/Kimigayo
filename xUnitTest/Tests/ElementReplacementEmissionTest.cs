...
public class ElementReplacementEmissionTest
{
    ...
    {
        { "Tuple", "var a = (\"old\", 42)\na.0 = \"new\"\nif a.1 == 42 => writeLine(\"ok\")", "old=1;new=1;ok=1" },
        { "Array", "var a: [2 of string] = [\"old\", \"sibling\"]\nvar i: isize = 0\na[i] = \"new\"\nwriteLine(\"ok\")", "old=1;sibling=1;new=1;ok=1" },
        { "Nested", "var a: (string, [1 of (string, i32)]) = (\"sibling\", [(\"old\", 0)])\na.1[0] = (\"new\", 42)\nif a.1[0].1 == 42 => writeLine(\"ok\")", "sibling=1;old=1;new=1;ok=1" },
        { "ArrayValue", "var a: ([2 of string], i32) = ([\"first\", \"last\"], 42)\na.0 = [\"newFirst\", \"newLast\"]\nif a.1 == 42 => writeLine(\"ok\")", "first=1;last=1;newFirst=1;newLast=1;ok=1" },
        { "Move", "var a = (\"old\", 42)\nlet text = \"new\"\na.0 = text\nlet moved = a\nwriteLine(\"ok\")", "old=1;new=1;ok=1" },
        { "AggregateMove", "var a = ((\"old\", 0), 1)\nlet value = (\"new\", 42)\na.0 = value\nif a.0.1 == 42 => writeLine(\"ok\")", "old=1;new=1;ok=1" },
