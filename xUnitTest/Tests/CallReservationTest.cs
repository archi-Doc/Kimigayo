...
public class CallReservationTest
{
    ...
    [InlineData("Generic", "func run<T>(c: uniq/Cell, x: ref/T) => set(c@deref@uniq, read(c))\nvar c = Cell.init()\nlet x = true\nrun(c@uniq, x)")]
    ...
    [InlineData("Object", "func put(o: objuniq/Cell, n: i32) => set(o@deref@uniq, n)\nvar o = Kimi.Intrinsics.makeObj(Cell.init())\nput(o@objuniq, read(o@deref@ref) + 1)\nrequire read(o@deref@ref) == 2 else => $abort(\"object\")")]
    [InlineData("ObjectReborrow", "func put(o: objuniq/Cell, n: i32) => set(o@deref@uniq, n)\nvar o = Kimi.Intrinsics.makeObj(Cell.init())\nlet u = o@objuniq\nput(u@objuniq, read(u@deref@ref) + 1)\nrequire read(u@deref@ref) == 2 else => $abort(\"object reborrow\")")]
    [InlineData("ObjectShared", "func peek(o: objref/Cell) -> i32 => read(o@deref@ref)\nfunc put(o: objuniq/Cell, n: i32) => set(o@deref@uniq, n)\nvar o = Kimi.Intrinsics.makeObj(Cell.init())\nput(o@objuniq, peek(o@objref) + 1)")]
    [InlineData("ObjectTyped", "func put(o: objuniq/Cell, n: i32) => set(o@deref@uniq, n)\nvar o = Kimi.Intrinsics.makeObj(Cell.init())\nput((o@objuniq/Cell), read(o@deref@ref) + 1)")]
    [InlineData("ObjectReceiver", "struct ObjCell\n    public var value: i32 = 1\n    public func put(self: objuniq/Self, n: i32)\n        let p = self@deref@uniq\n        p.value = n\nvar o = Kimi.Intrinsics.makeObj(ObjCell.init())\nlet n = (o@deref@ref).value\no@objuniq.put(n + 1)\nrequire (o@deref@ref).value == 2 else => $abort(\"object receiver\")")]
    ...
    [InlineData("func put(o: objuniq/Cell, n: i32) => set(o@deref@uniq, n)\nvar o = Kimi.Intrinsics.makeObj(Cell.init())\nput(o, read(o@deref@ref) + 1)")]
