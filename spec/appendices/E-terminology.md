...
| Iterator / LendingIterator | The enumeration Contract whose items survive later `next` calls and Moves under a published effect bound / the general Contract whose items may borrow the Iterator. | [Iterator independence](../22-core-execution-and-foreign-functions.md#22124-iterator-independence) |
