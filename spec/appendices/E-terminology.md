...
| Composition Root | Reserved root for language-provided `$` operations; only `$abort(...)` is defined in this revision. | [Reserved syntax](../13-operators-and-assignment.md#138-extension-boundaries-and-reserved-syntax) |
