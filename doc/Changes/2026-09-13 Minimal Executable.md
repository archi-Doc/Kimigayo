...
The helper archive is adopted under the shared Directory.Build.props release after two reproducible builds, helper tests, assembly/unwind review and emitted-module execution. This is the literal-output milestone, not a claim of complete SPEC §A.14 coverage for unsupported language features. Full Core execution, general source functions/locals, Library emission, general layout/ABI and borrowed/object execution remain pending.
