...
2026-09-13 改訂。[決定記録](../Decisions/2026-09-13%20Generic%20Sharing%20Review.md)の精査結果を統合した。**本書の対象では本書がSPEC.mdと先行設計文書に優先する。** 2026-09-14 に SPEC.md §21.3・§21.4.6、付録 A.14・B.7・D.1 と関連節へ統合した。実装状況は [STATUS.md](../../STATUS.md) を参照する。仕様の統合はコンパイラー実装の完了を示さない。
