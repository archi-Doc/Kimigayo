...
| 8 | P31 | Dictionary | IN_PROGRESS | Designated declarations, typed literals and operation signatures bind with required key equality and component-dependent Owned classification. Runtime storage, metadata, mutation, insertion order, iteration, Loans and allocation-free churn remain. |
