...
The compiler-wide plan covers unfinished implementation Milestones and Checklist items. The current focused request integrates the finalized 2026-09-21 Origin redesign into the formal specification and compiler, including affected library, example, milestone and test sources. The approved design takes precedence over conflicting previous rules. Draft edits and NativeAOT tests are excluded from this integration.
