...
| 8 | P31 | Dictionary | IN_PROGRESS | Empty handles, metadata, reserve, owned transfer, search/mutation APIs, lookup Loans, reverse insertion cleanup and allocation-free churn execute natively. Generic/zero-sized entries and failure-preserving shrink also pass. Keyed assignment, iteration, nonempty literals and nested collection storage remain. |
