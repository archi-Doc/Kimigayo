...
| 8 | P31 | Dictionary | IN_PROGRESS | Designated declarations, typed literals and operation signatures bind with required key equality and component-dependent Owned classification. Empty handles, metadata, reserve, owned transfer and cleanup execute natively. Entry mutation, insertion order, iteration, lookup Loans and allocation-free churn remain. |
