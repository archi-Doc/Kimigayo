...
3. **Copy read and default follow-ups:** aggregate Copy referent reads (a storage copy through a borrowed aggregate, currently `UnsupportedOwnership_Kd`), default calls with receivers, borrowed arguments or nested omitted defaults, and the Loan-conflict diagnostic cascade (G13).
