...
P18-G, P18-O and P18-V are complete. Stop here; do not start Program 19. ORD4 is complete for its bounded paths; OSE3 and the following compiler-wide actions remain backlog and are not current execution instructions.
