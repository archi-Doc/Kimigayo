...
- **Verified source HEAD** `fd61538c` plus documentation records. Debug/Release builds are warning-free; each full suite passes 11,319 tests. Session evidence: `bin/verify/20260922-123415-session-optional-session-recovery`; all existing harnesses (1–12 and 14–18) and 46 optional/try native O0/O2 executions pass.
