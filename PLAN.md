...
| 8 | P31 | Dictionary | IN_PROGRESS | Empty handles, metadata, reserve, owned transfer, search/mutation APIs, lookup Loans, reverse insertion cleanup and allocation-free churn execute natively. Keyed assignment, iteration, shrink, literals and general entry storage remain. |
