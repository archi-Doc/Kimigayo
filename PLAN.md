...
| 7 | P30 | Equatable/Comparable Contracts | IN_PROGRESS | Primitive/user/generic calls/operators and Copy aggregate snapshots pass; Tuple/shared-borrow composition and the complete Program 30 harness remain. |
