...
2026-09-13。[設計仕様](../Design/2026-09-13%20Value%20Borrows%20Closures%20and%20Metadata.md)に採用分を反映した。§1 は最初の修正案、§2 は追加レビューの記録で、後の決定を優先する。2026-09-15 同期確認: 規則は [SPEC 第21章](../../spec/21-layout-runtime-and-code-generation.md) と関連節へ統合済み。現行の規範は SPEC、実装状況は STATUS を参照する。
...
| SPEC §21 の注記 | 当時は後続の同期対象とした。現在は本文へ統合済みであり、設計書を現行本文へ優先する注記は解除した |
