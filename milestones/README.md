...
| 31 | YES | PASS (Debug, O2 Application) | PASS (Debug, O0/O2 target fixture) | Unchanged target, exact output and one buffer allocation/release pass alongside 842 related tests and 80 Dictionary O0/O2 executions (`bin/verify/20260924-065552-186-unit-dictionary-index-regressions`). The ordinary Debug compiler also verifies and links the Application at O2. Dedicated harness, Release/session completion and nonempty literal coverage remain pending; P31 is IN_PROGRESS. |
