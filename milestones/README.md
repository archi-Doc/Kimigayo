...
| 31 | YES | FAIL (Debug/Release, O0/O2) | NOT_RUN | The current Binding baseline identifies `Dictionary<Key, Item>` formation with `InvalidTypeFormation_Kd`; dependent declaration errors are suppressed. Native build status retains the [authoring evidence](../PLAN_HISTORY.md#programs31-33-authoring). |
