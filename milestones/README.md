...
| 27 | YES | FAIL | FAIL (prior Debug/Release, O0/O2 probes) | NOT_RUN | TODO | Current Binding first reports `UnresolvedBinding_Kd` at `middle.splitAt`; Range values, Index resolution, Index/Range/ResolvedRange keys, nested views and the Place foundation are verified, the Slice operations remain. [Authoring evidence](../PLAN_HISTORY.md#programs25-28-authoring). |
